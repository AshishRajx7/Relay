...
export const validationSchema = Joi.object({
  ...
  AI_MODEL: Joi.string().default('nvidia/nemotron-3-super-120b-a12b'),
  AI_MATCHING_MODEL: Joi.string().optional(),
  AI_WRITING_MODEL: Joi.string().optional(),
  AI_VERIFICATION_MODEL: Joi.string().optional(),
...
export const configuration = (): AppConfig => ({
  ...
  ai: {
    ...
    model: process.env.AI_MODEL || process.env.OPENAI_MODEL || 'nvidia/nemotron-3-super-120b-a12b',
    matchingModel: process.env.AI_MATCHING_MODEL || process.env.AI_MODEL || 'nvidia/nemotron-3-super-120b-a12b',
    writingModel: process.env.AI_WRITING_MODEL || process.env.AI_MODEL || 'nvidia/nemotron-3-super-120b-a12b',
    verificationModel: process.env.AI_VERIFICATION_MODEL || process.env.AI_MODEL || 'nvidia/nemotron-3-super-120b-a12b',
