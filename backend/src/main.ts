...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    ...
    .addTag('AI Diagnostic', 'AI provider configuration and health diagnostics')
    .addTag('Cold Email Outreach', 'Personalized cold email generation, editing, and approval')
